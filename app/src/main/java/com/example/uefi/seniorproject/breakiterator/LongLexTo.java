...
//            System.out.println(" !!! Error: Missing default dictionary file, lexitron.txt");
    ...
    /*******************************************************************/
    public LongLexTo(InputStream dictFile) throws IOException {
...
//            System.out.println(" !!! Error: The dictionary file is not found, " + dictFile.getName());
    ...
    public void addDict(InputStream dictFile/*File dictFile*/) throws IOException {
...
//    } //lineInstance
    ...
    public  void genOutput(String line,String outFileName, LongLexTo tokenizer) throws IOException {
...
//    while((line=br.readLine())!=null) {
        // line=line.trim();
        System.out.print("LINELENGTH = "+line.length());
        if(line.length()>0) {
...
//                ProcessedText+= line.substring(begin, end) + "-";
            ...
            System.out.print("PRINT = PROCESSTEXT"+ProcessedText);
//            fw.write("<br>\n");
            ProcessedText+="<br>\n";
