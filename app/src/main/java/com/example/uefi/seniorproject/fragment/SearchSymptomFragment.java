...
public class SearchSymptomFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    ArrayList<ArrayList<Double>> countword = new ArrayList<ArrayList<Double>>();
    Integer[] freq;
    Double[] lengthDoc;
...
//            return null;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            viewHolder.img.setImageResource(gridViewImageId2[Arrays.asList(gridViewString).indexOf(type.split(",")[0].trim())]);
